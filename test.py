...
vel_list = [2.0, 22.0]          # velocità vettoriale descritta come direzione (in radianti N/NE) e velocità in m/s
...
res = ad.run(vel_list, wind_str, pos, h, Cd, S, m, time, step, integrator)
